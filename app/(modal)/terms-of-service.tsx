  ...
  const termSections: TermSection[] = [
    {
      ...
      content: [
        ...
        'يجب أن تكون بالغاً (16 سنة) أو تستخدم التطبيق بإشراف ولي الأمر.'
      ]
    },
    {
      title: 'إنشاء الحساب',
    ...
    },
    {
      ...
      content: [
        ...
        'في حال وجود مشكلة بالطلب، يرجى الاتصال بنا خلال 20 دقيقة من الاستلام.',
            ...
            <View style={styles.importantContent}>
              ...
              <View>
                ...
                <Text style={styles.importantText}>
                  ...
                  • للاستفسارات القانونية: info@almalaky.co
                </Text>
              </View>
            </View>
          </View>
